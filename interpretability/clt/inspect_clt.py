...
def audit_clt(clt_path, activations_path, top_k=10):
    ...
    x_target = data["pred"].float().to(device)
    ...
    # 4. Success vs Failure Split
    # 0-2002: Snapshots
    # 2002-8414: Pickup Cup (Failure-heavy)
    # 8414-14814: Pickup Grasp (Success baseline)
    ...
    encoder_weights = clt.encoder.weight[top_neuron_idx]
